...
execute as @s[tag=la_wields_mainhand] at @s run execute as @s[nbt={SelectedItem:{tag:{explosion_crystal:1b}}}] run function legendary_artifacts:artifacts/explosion_crystal
execute as @s[tag=la_wields_mainhand] at @s run execute as @s[nbt={SelectedItem:{tag:{bad_smelling_potato:1b}}}] run function legendary_artifacts:artifacts/bad_smelling_potato
...
execute as @s[tag=la_wields_offhand] at @s run execute as @s[nbt={Inventory:[{Slot:-106b, tag:{explosion_crystal:1b}}]}] run function legendary_artifacts:artifacts/explosion_crystal
execute as @s[tag=la_wields_offhand] at @s run execute as @s[nbt={Inventory:[{Slot:-106b, tag:{bad_smelling_potato:1b}}]}] run function legendary_artifacts:artifacts/bad_smelling_potato
