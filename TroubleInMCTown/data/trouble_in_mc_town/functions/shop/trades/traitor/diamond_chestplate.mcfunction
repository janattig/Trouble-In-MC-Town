...
data modify entity @s Offers.Recipes[0].buy.Count set value 15b
item replace entity @s villager.0 with leather_chestplate 1
data modify entity @s Offers.Recipes[0].buyB set from entity @s Inventory[0]

item replace entity @s villager.0 with diamond_chestplate{Enchantments:[{id:"minecraft:protection",lvl:3s},{id:"minecraft:unbreaking",lvl:1s},{id:"minecraft:vanishing_curse",lvl:1s}]} 1
...
data modify entity @s Offers.Recipes[0].sell.tag.Damage set value 500
